...
{% swagger-parameter in="body" name="fileExtension" type="String" required="true" %}
...
{% swagger-parameter in="header" name="X-Sender" type="String" %}
Mã định danh người gọi.
{% endswagger-parameter %}

{% swagger-parameter in="header" name="X-APIKey" type="String" %}
